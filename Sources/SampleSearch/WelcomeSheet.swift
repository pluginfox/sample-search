...
struct WelcomeSheet: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            ...
            step(1, "Add your Trigger 2 folders",
                 "Point the app at the folders holding your .tci instruments and .wav / .aiff one-shots. “Find TCI Files Automatically” uses Spotlight to suggest them. Nothing is moved or renamed.")
            ...
            step(3, "Point Trigger 2's browser at the Sample Search folder",
                 "The app keeps a folder of links at \(abbreviated(BrowserFolder.url.path)), grouped by favourites, tags, kits, categories, sources and vendors, with your current selection at the top level. Add that folder in Trigger 2's browser once; it updates itself as you tag.")
